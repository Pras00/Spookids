...
<head>
    ...
    <title>Upsell Page - Spookids</title>
</head>
...
<body>
    <div class="container-lg bg-6">
        <div class="flex flex-col items-center justify-center h-screen px-5">
            <div class="border-0 bg-[#FC9850] rounded-2xl px-4 md:px-6 lg:px-8 py-5 w-full md:w-[40%] h-[60%] md:h-[90%] flex flex-col items-center justify-center text-center text-[#312E35]">
                ...
                <a href="#intro" class="w-[10%] md:w-[8%] mt-3">
    ...
    <div id="intro" class="container-lg bg-3">
        <div class="flex flex-col items-center justify-center text-center p-5 py-16 text-[#312E35]">
            ...
            <div class="flex flex-col items-center justify-center text-center w-full md:w-[80%]">
                <div class="bg-5 rounded-lg p-5 md:p-8 text-center text-[#312E35] flex flex-col md:flex-row items-center mb-8">
                    <div class="md:w-2/3 order-2 md:order-1 md:mr-16 flex flex-col items-center">
                        <h3 class="bg-[#FC9850] text-[#312E35] rounded-full py-1 halloween font-1-2rem mb-5 px-8">
                            Over 60+ Spooky Tales to Choose From
                        </h3>
                        <p class="montserrat-medium font-1rem text-[#F3E9D3]">
                ...
                <div class="bg-5 rounded-lg p-5 md:p-8 text-center text-[#312E35] flex flex-col md:flex-row items-center mb-8">
                    <div class="md:w-2/3 order-2 md:order-1 md:mr-16 flex flex-col items-center">
                        <h3 class="bg-[#FC9850] text-[#312E35] rounded-full py-1 halloween font-1-2rem mb-5 px-3">
    ...
    <div class="container-lg bg-6">
        <div class="flex flex-col items-center justify-center p-3 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-1 gap-8 mx-0 md:mx-8 lg:mx-24 p-3 text-white">
                <div class="border-0 bg-[#F3E9D3] drop-shadow-lg rounded-2xl h-full md:h-[55%]">
                    <h1 class="bg-[#312E35] halloween font-2rem mt-8 text-[#F3E9D3] text-center">
                ...
                <div class="border-0 bg-[#F3E9D3] drop-shadow-lg rounded-2xl h-full">
    ...
    <div class="container-lg bg-3">
        <div class="flex flex-col items-center justify-center text-center py-16 px-3 md:px-0">
            <h2 class="halloween font-3rem w-full md:w-[50%] px-3">
            ...
            <div class="flex flex-col items-center justify-center text-center py-8 md:py-12 px-3 md:px-0">
                <div class="w-full md:w-[80%] flex flex-col justify-center items-center">
                    <h3 class="bg-[#F3E9D3] text-[#312E35] rounded-full py-2 montserrat-bold font-1-2rem w-full md:w-[40%]">
                        SEE WHAT'S INSIDE SPOOKIDS PRO!
                    </h3>
        ...
        <div class="container-lg bg-1">
            <div class="flex flex-col items-center justify-center px-5 md:px-0">
                <div class="border-0 bg-2 rounded-2xl m-12 md:m-24 px-4 md:px-6 lg:px-8 py-8 md:py-16 w-full md:w-[60%] flex flex-col items-center justify-center text-center text-[#312E35]">
                    ...
                    <h1 class="montserrat-medium font-1-5rem mt-16">
                        Secure Your Special Price for Only <span class="line-through">  $97 $67 $47</span> <br>
                        <span class="halloween font-2-5rem text-[#FC9850]">JUST $37</span>
                    </h1>
